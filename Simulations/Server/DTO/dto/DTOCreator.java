...
import logic.dto.SimulationManagerDTO;
import logic.dto.SimulationOutputDTO;
import logic.dto.WorldInstanceDTO;
...
public class DTOCreator {
    ...
    public SimulationManagerDTO createManagerSimulationDTO(SimulationsManager simulationsManager){
        ...
        for(Simulation simulation : pastSimulation){
            simulationDTO = createSimulationDTO(simulation.getWorldDefinition(),simulation, simulation.getSimulationOutput());
